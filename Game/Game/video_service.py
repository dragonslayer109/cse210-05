...
class VideoService:
    ...
    def display_actors(self, actors):
        """Draws the Actors within the collection.

        Args:
            actors: A collection of Actors.
        """ 
    ...
    def _draw_grid(self):
        ...
        for x in range(0, constants.MAX_X, constants.CELL_SIZE):
            pyray.draw_line(x, 0, x, constants.MAX_Y, pyray.WHITE)

        for y in range(0, constants.MAX_Y, constants.CELL_SIZE):
            pyray.draw_line(0, y, constants.MAX_X, y, pyray.WHITE)
